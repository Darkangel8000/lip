...
%token IF THEN ELSE DO WHILE SKIP ASSIGN ":=" SEQ ";" COMMA "," RETURN
%token ADD SUB MUL
...
prog:/* regola di produzione */
  | ds = list(decl) c = cmd EOF { Prog (ds, c) }

cmd:/* regola di produzione */
  | SKIP { Skip }
